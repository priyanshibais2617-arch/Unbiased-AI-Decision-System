    ...
    <div className="flex flex-col h-full w-full bg-slate-50 absolute inset-0 z-10 animate-in slide-in-from-right-full duration-300">
      ...
      <div className="flex-1 overflow-y-auto p-5 custom-scrollbar space-y-6">
        ...
        <div className="bg-white p-5 rounded-2xl shadow-sm border border-slate-100">
          ...
          <Button variant="outline" className="w-full mt-4 text-rose-600 border-rose-200 hover:bg-rose-50 hover:text-rose-700 rounded-xl h-10 text-xs font-bold flex items-center gap-2">

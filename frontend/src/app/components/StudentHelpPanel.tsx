    ...
    <div className="flex flex-col h-full w-full bg-slate-50 absolute inset-0 z-10 animate-in slide-in-from-right-full duration-300">
      ...
      <div className="flex-1 overflow-y-auto p-5 custom-scrollbar relative">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <button 
            onClick={() => window.location.href = "mailto:support@educationeval.com?subject=Support Request&body=Hi Support Team,"}
            className="flex flex-col items-center justify-center p-4 rounded-xl bg-white border border-slate-200 hover:border-teal-300 hover:shadow-md transition-all group"
          >
          ...
          <button 
            onClick={() => alert("Live Chat SDK Placeholder: Here you would integrate Intercom or Zendesk.")}
            className="flex flex-col items-center justify-center p-4 rounded-xl bg-white border border-slate-200 hover:border-teal-300 hover:shadow-md transition-all group"
          >
